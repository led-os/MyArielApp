...
/**
 * <描述>
 *     常用地址设置-搜索poi结果-adapter
 */
public class NaviPoiSearchAdapter extends RecyclerView.Adapter<NaviPoiSearchAdapter.SearchHistoryHodler> {
    private OnClickListener mClickListener;
    private List<NavAddressInfoBean> datas;
    private Context mContext;
    private String mPresetType;

    public NaviPoiSearchAdapter(List<NavAddressInfoBean> datas) {
        this.datas = datas;
        mPresetType = "";
    }
