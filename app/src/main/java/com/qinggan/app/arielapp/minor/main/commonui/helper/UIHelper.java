package com.qinggan.app.arielapp.minor.main.commonui.helper;
...
public class UIHelper {
    ...
    public static String getString(int stringId) {
        Context context = ArielApplication.getApp().getContext();
        if (context != null) {
    ...
    public static int getDimension(@DimenRes int dimenRes) {
        return (int) ArielApplication.getApp().getContext().getResources().getDimension(dimenRes);
    }
    ...
    public static int getColor(@ColorRes int color) {
        return ContextCompat.getColor(ArielApplication.getApp().getContext(), color);
    }
    ...
    public static Drawable getDrawable(int drawable) {
        return ContextCompat.getDrawable(ArielApplication.getApp().getContext(), drawable);
    }
