 ...
 * @since 2013-7-29
 */
public class SoPullExtendLayout extends LinearLayout implements IPullToExtend {
    ...
    public SoPullExtendLayout(Context context) {
        this(context, null);
    }


    public SoPullExtendLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public SoPullExtendLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                SoPullExtendLayout.this.postDelayed(this, 16);// SUPPRESS CHECKSTYLE
            }
        }
