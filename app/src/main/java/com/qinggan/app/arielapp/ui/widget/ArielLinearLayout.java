...
public class ArielLinearLayout extends LinearLayout{
    public ArielLinearLayout(Context context) {
        super(context);
        setWillNotDraw(false);
    }

    public ArielLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        setWillNotDraw(false);

    }

    public ArielLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        LayoutParams layoutParams =new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,dp2px(context,213));
     ...
     * @return
     */
    public static Drawable topToBottomDrawable( String StartColor, String EndColor) {
